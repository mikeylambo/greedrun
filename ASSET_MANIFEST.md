...
- **Orientation — DECIDED: 3/4 top-down** (Hades/Zelda-style), locked by the Jo turnaround
  set (v0.3.1). Every character, enemy, and top-down loot asset follows it. Side views are
  authored facing LEFT and mirrored in-engine — never author a second side direction.
